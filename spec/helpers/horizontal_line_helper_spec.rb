...
describe 'Drawing Line Helper' do
  ...
  it 'has set horizontal line variables' do
    set_horizontal_line_array_variables("L 1 2 6 2")
    expect(@x1).to eq "1"
    expect(@y1).to eq "2"
    expect(@x2).to eq "6"
    expect(@y2).to eq "2"
  ...
  it 'calculates horizontal line array for a canvas of 20,4 and a horizontal line of 1,2 6,2' do
	...
	@drawing_program.set_horizontal_line_array_variables("L 1 2 6 2")
  ...
  it 'calculates horizontal line array for a canvas of 10,5 and a horizontal line of 3,3 9,3' do
	...
	@drawing_program.set_horizontal_line_array_variables("L 3 3 9 3")
    @drawing_program.calculate_horizontal_line_array
  ...
  it 'display canvas with horizontal line for a canvas of 10,5 and a horizontal line of 3,3 9,3 and precompile_horizontal_line_data method works' do
  	@drawing_program.create_canvas("C 18 5")
  	@drawing_program.precompile_horizontal_line_data("L 3 3 9 3")
